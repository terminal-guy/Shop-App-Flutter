    ...
    if (_isInit) {
      ...
      if (productId != null) {
        ...
        _initValues = {
          ...
          'imageUrl': '',
          // we are doing this cuz if we have a controller we can't use initialvalue.
          // instead the controller to the initialvalue and that will the reflected on the screen.
        };
